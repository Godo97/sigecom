...
Route::resource('competencia/compenvl2', Controllers\Compenvl1Controller::class)->except('index');
Route::resource('competencia/compenvl3', Controllers\Compenvl1Controller::class)->except('index');
